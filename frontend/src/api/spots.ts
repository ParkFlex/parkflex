...
export const getSpots = async (
    ...
    return [
        ...
        { id: 8, role: "blank", occupied: false },
        { id: 9, role: "blank", occupied: false },
        { id: 10, role: "blank", occupied: false },
        { id: 11, role: "blank", occupied: false },
        { id: 12, role: "blank", occupied: false },
        { id: 13, role: "normal", occupied: false },
        { id: 14, role: "blank", occupied: false },
        { id: 15, role: "normal", occupied: false },
        { id: 16, role: "normal", occupied: false },
        { id: 17, role: "blank", occupied: false },
        { id: 18, role: "normal", occupied: false },
        { id: 19, role: "normal", occupied: true },
        { id: 20, role: "blank", occupied: false },
        { id: 21, role: "normal", occupied: false },
        { id: 22, role: "normal", occupied: false },
        { id: 23, role: "blank", occupied: false },
        { id: 24, role: "normal", occupied: true },
        { id: 25, role: "normal", occupied: false },
        { id: 26, role: "blank", occupied: false },
        { id: 27, role: "normal", occupied: false },
        { id: 28, role: "normal", occupied: true },
        { id: 29, role: "blank", occupied: false },
        { id: 30, role: "normal", occupied: true },
        { id: 31, role: "normal", occupied: false },
        { id: 32, role: "blank", occupied: false },
        { id: 33, role: "blank", occupied: false },
        { id: 34, role: "blank", occupied: true },
        { id: 35, role: "blank", occupied: false },
        { id: 36, role: "normal", occupied: false },
        { id: 37, role: "normal", occupied: false },
        { id: 38, role: "blank", occupied: true },
        { id: 39, role: "normal", occupied: false },
        { id: 40, role: "normal", occupied: false },
        { id: 41, role: "blank", occupied: false },
        { id: 42, role: "normal", occupied: false },
    ];
};
