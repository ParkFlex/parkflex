...
/**
 * Service for generating mock data for testing and development purposes.
 */
object MockDataService {

    /**
     * Generates and inserts mock data into the database.
     * Creates sample users, spots, reservations, penalties, and parameters.
     */
    fun generateMockData() {
        transaction {
            ...
            val user1 = UserEntity.new {
                ...
                hash = "hashed_password_123" // In production, use proper password hashing
                plate = "ABC-1234"
                role = "user"
                blocked = false
            }
            ...
            val blockedUser = UserEntity.new {
                login = "blocked.user"
            ...
            val reservation1 = ReservationEntity.new {
            ...
            val reservation2 = ReservationEntity.new {
